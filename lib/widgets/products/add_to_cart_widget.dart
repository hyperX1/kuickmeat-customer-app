...
import 'package:kuickmeat_app/widgets/cart/counter_widget.dart';
...
class _AddToCartWidgetState extends State<AddToCartWidget> {
  ...
  @override
  void initState() {
    //while opening product details screen, first will check this item that whether
    //it's already in cart or not
    getCartData();
    super.initState();
  }
  ...
  getCartData() async {
    ...
    if (snapshot.docs.length == 0) {
      //means this product is not added to cart
      setState(() {
        _loading = false;
      });
    } else {
