          ...
          children: [
            Stack(
              children: [
                ...
                if(document.data()['comparedPrice']>0) //it will only show those products iff any discount offer available
                Container(
                  decoration: BoxDecoration(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            if(document.data()['comparedPrice']>0) //only show if it has a value or more than 0
                            Text(
