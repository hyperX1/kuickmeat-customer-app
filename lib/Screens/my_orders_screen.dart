                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text(
                                        document.data()['deliveryBoy']['name'],style: TextStyle(
                                      fontSize: 14,
                                    ),),
                                    subtitle: Text(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 12, right: 12, top: 9, bottom: 8),
                                  child: Card(
                                    elevation: 4,
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          if (int.parse(
                                              ...
                                              0) //only if discount available, it'll show
                                            Container(
                                              child: Column(
                                                children: [
                                                  Row(
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                'Rs. ${document.data()['deliveryFee'].toString()}',
                                                style: TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 12,
                                                ),
